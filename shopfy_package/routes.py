...
from shopfy_package.forms import RegistrationForm, LoginForm, SettingForm, ProductForm
from shopfy_package.models import User, Products
...
def home():
	...
	slide_1 = url_for("static", filename="slides/watchwallpaper.jpg")
	slide_2 = url_for("static", filename="slides/t-shirt-wallpaper.jpg")
	slide_3 = url_for("static", filename="slides/bodyspray.jpg")
	...
	return render_template('home2.html',title = 'home',product=product,profile=profile,slide_3=slide_3,slide_2=slide_2,slide_1=slide_1)
...
@login_required
def carts():
	return render_template('carts.html',title='carts')
...
def my_shop():
	...
	#profile = url_for("static", filename="Users_profiles/default.jpg")
	return render_template('my_shop.html',title=current_user.username, profile=profile,product=product,computer=computer)
...
def to_seller():
	...
	computer = url_for("static", filename="computer/71GbO41HbYL._SL1500_.jpg")
	profile = url_for("static", filename="Users_profiles/" + current_user.profile)
	return render_template('to_seller.html',title='seller', profile=profile,product=product,computer=computer)
...
def products(Products_id):
	...
	return render_template('products.html',product=product,title=product.product_name,profile=profile)
...
def user_products(username):
	...
	return render_template('seller_products.html',product=product,title=username,profile=profile,user=user)
